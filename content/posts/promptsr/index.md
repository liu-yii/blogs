...
![text-image](img/text-image.png)

具体的实验结果可以参考原论文：
![exp](img/exp.png)

## 总结
我觉得这类基于扩散模型微调的图像复原网络基本上都是基于SD的，网络结构上的差异不会太大。创新点主要集中于生成degradation的pipe，以及如何利用SD中的文本能力。
这篇文章的主要创新点就在于将图像的退化类型作为文本信息输入扩散模型中，文章也并未开源，可以略作参考。